      ...
      <el-col :span="18">
        <el-card class="box-card">
          ...
          <el-form :inline="true" :model="searchForm">
            <el-form-item label="销售属性名">
              <el-input v-model="searchForm.attrName" placeholder="输入销售属性名" style="width:180px;" clearable></el-input>
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="doSearch">查询</el-button>
              <el-button type="success" @click="openAdd" :disabled="!curCategoryId">新增销售属性</el-button>
            </el-form-item>
          </el-form>
          ...
          <el-table :data="tableData" style="width:100%" border>
            ...
            <el-table-column prop="attrName" label="销售属性名" width="160"></el-table-column>
            ...
            <el-table-column prop="attrValue" label="可选值" min-width="180">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="520px" :close-on-click-modal="false">
      <el-form :model="attrForm" label-width="100px" ref="attrForm">
        <el-form-item label="属性名称" prop="attrName" required>
          <el-input v-model="attrForm.attrName" placeholder="输入销售属性名称（给 SKU 使用）"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    openEdit(row) {
      this.opType = 'edit'
      this.dialogTitle = '编辑销售属性【' + row.attrName + '】'
      this.attrForm = {
        id: row.id,
    ...
    doDelete(row) {
      this.$confirm('确认删除销售属性【' + row.attrName + '】吗？', '提示', {
        type: 'warning'
      }).then(() => {
